...
#define REMOTE_SERVER_PORT 1500 //defina aqui qual porta usar na comunicação do socket.
...
int main(int argc, char *argv[]){
  ...
  hostAddress.sin_port = htons(REMOTE_SERVER_PORT); //converte o numero da porta para o endereço corret
